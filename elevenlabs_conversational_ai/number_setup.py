...
def upload_xml(xml_string):
    ...
    filename = "elevenlabs-conversational-ai.xml"  # Change this to your desired filename
...
def create_application(xml_url):
    ...
    response = client.applications.create(
        app_name='elevenlabs-conversational-ai',  # Change this to your desired application name
        answer_url=xml_url,
        answer_method='GET'
    )
